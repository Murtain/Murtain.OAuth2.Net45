...
{
    [AutoMap(typeof(ValidateGraphicCaptchaAndResendMessageCaptchaRequestModel))]
    public class ValidateGraphicCaptchaAndResendMessageCaptchaViewModel : ErrorViewModel
    {
        [Required]
