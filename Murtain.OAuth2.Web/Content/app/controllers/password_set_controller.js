...
define(['app', 'app.constants', 'services/account_service', 'services/captcha_service'], function (app) {
    ...
    app.controller('PasswordSetController', fnPasswordSetController)

    fnPasswordSetController.$inject = ['$scope', '$rootScope', '$timeout', 'account_service', 'constants', '$stateParams', '$interval', '$state'];

    function fnPasswordSetController($scope, $rootScope, $timeout, account_service,  constants, $stateParams, $interval, $state) {
    ...
    return fnPasswordSetController;
});